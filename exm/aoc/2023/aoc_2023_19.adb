...
procedure AoC_2023_19 is
  ...
  procedure Do_Part_2 is
    ...
    procedure Part_2_Mini is
      d_x : constant array (1 .. 5) of Positive := (1, 1416, 2441, 2663, 4001);
      d_m : constant array (1 .. 6) of Positive := (1, 839, 1549, 1801, 2091, 4001);
      d_a : constant array (1 .. 5) of Positive := (1, 1717, 2006, 3334, 4001);
      d_s : constant array (1 .. 6) of Positive := (1, 537, 1351, 2771, 3449, 4001);
    begin
