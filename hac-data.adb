package body HAC.Data is
  ...
  begin
    ...
    AdaKeyWSy (8)  := ATSy;
    AdaKeyW (9)    := "BEGIN     ";
    AdaKeyWSy (9)  := BEGIN_Symbol;
    AdaKeyW (10)   := "BODY      ";
    AdaKeyWSy (10) := BodySy;
    AdaKeyW (11)   := "CASE      ";
    AdaKeyWSy (11) := CaseSy;
    AdaKeyW (12)   := "CONSTANT  ";
    AdaKeyWSy (12) := CONSTANT_Symbol;
    AdaKeyW (13)   := "DECLARE   ";
    AdaKeyWSy (13) := DeclareSy;
    AdaKeyW (14)   := "DELAY     ";
    AdaKeyWSy (14) := DelaySy;
    AdaKeyW (15)   := "DELTA     ";
    AdaKeyWSy (15) := USy;
    AdaKeyW (16)   := "DIGITS    ";
    AdaKeyWSy (16) := USy;
    ...
    AdaKeyWSy (18) := ElseSy;
    AdaKeyW (19)   := "ELSIF     ";
    AdaKeyWSy (19) := ElsIfSy;
    AdaKeyW (20)   := "END       ";
    AdaKeyWSy (20) := END_Symbol;
    AdaKeyW (21)   := "ENTRY     ";
    AdaKeyWSy (21) := EntrySy;
    AdaKeyW (22)   := "EXCEPTION ";
    AdaKeyWSy (22) := USy;
    AdaKeyW (23)   := "EXIT      ";
    AdaKeyWSy (23) := EXIT_Symbol;
    AdaKeyW (24)   := "FOR       ";
    AdaKeyWSy (24) := FOR_Symbol;
    AdaKeyW (25)   := "FUNCTION  ";
    AdaKeyWSy (25) := Function_Symbol;
    AdaKeyW (26)   := "GENERIC   ";
    AdaKeyWSy (26) := USy;
    AdaKeyW (27)   := "GOTO      ";
    AdaKeyWSy (27) := USy;
    AdaKeyW (28)   := "IF        ";
    AdaKeyWSy (28) := IF_Symbol;
    AdaKeyW (29)   := "IN        ";
    AdaKeyWSy (29) := InSy;
    AdaKeyW (30)   := "IS        ";
    AdaKeyWSy (30) := Is_Symbol;
    AdaKeyW (31)   := "LIMITED   ";
    AdaKeyWSy (31) := USy;
    AdaKeyW (32)   := "LOOP      ";
    AdaKeyWSy (32) := Loop_Symbol;
    AdaKeyW (33)   := "MOD       ";
    AdaKeyWSy (33) := ModSy;
    AdaKeyW (34)   := "NEW       ";
    AdaKeyWSy (34) := USy;
    ...
    AdaKeyW (43)   := "PRIVATE   ";
    AdaKeyWSy (43) := USy;
    AdaKeyW (44)   := "PROCEDURE ";
    AdaKeyWSy (44) := Procedure_Symbol;
    AdaKeyW (45)   := "RAISE     ";
    AdaKeyWSy (45) := USy;
    AdaKeyW (46)   := "RANGE     ";
    AdaKeyWSy (46) := RangeSy;
    AdaKeyW (47)   := "RECORD    ";
    AdaKeyWSy (47) := RecordSy;
    AdaKeyW (48)   := "REM       ";
    AdaKeyWSy (48) := USy;
    AdaKeyW (49)   := "RENAMES   ";
    AdaKeyWSy (49) := USy;
    AdaKeyW (50)   := "RETURN    ";
    AdaKeyWSy (50) := ReturnSy;
    AdaKeyW (51)   := "REVERSE   ";
    AdaKeyWSy (51) := ReverseSy;
    AdaKeyW (52)   := "SELECT    ";
    AdaKeyWSy (52) := SelectSy;
    AdaKeyW (53)   := "SEPARATE  ";
    AdaKeyWSy (53) := USy;
    AdaKeyW (54)   := "SUBTYPE   ";
    AdaKeyWSy (54) := SubTypeSy;
    AdaKeyW (55)   := "TASK      ";
    AdaKeyWSy (55) := TaskSy;
    AdaKeyW (56)   := "TERMINATE ";
    AdaKeyWSy (56) := TerminateSy;
    AdaKeyW (57)   := "THEN      ";
    AdaKeyWSy (57) := THEN_Symbol;
    AdaKeyW (58)   := "TYPE      ";
    AdaKeyWSy (58) := TypeSy;
    AdaKeyW (59)   := "USE       ";
    AdaKeyWSy (59) := UseSy;
