  ...
  is
    ...
    begin
      ...
      if X.TYP = Y.TYP then
        if StanTyps (X.TYP) then
          ...
          case X.TYP is
            when Arrays =>
              Emit1 (23, ArraysTab (X.Ref).Size);
            when Records =>
              Emit1 (23, BlockTab (X.Ref).VSize);
            when Enums =>
              Emit (38);
            when others =>
              null;
    ...
    procedure Statement (FSys : Symset) is
      ...
      begin
        ...
        Emit1 (32 + Boolean'Pos (IsFun), CallSTDP);       -- unconditional
                                                          --procedure Exit
      end ReturnStatement;
      ...
      procedure SelectStatement is
        ...
        procedure SelectiveWait is         -- Kurtz <===================
          ...
          end AcceptStatement2;                  -- AcceptStatement2
        ...
        begin          -- SelectiveWait ===============================> Kurtz
          ...
          do_terminate := False;
          StartSel     := LC;
          Emit2 (73, 1, 0);             -- START OF SELECT SELECTIVE Wait
                                        --SEQUENCE
          loop
            case Sy is
              when WhenSy =>
    ...
    begin  -- Statement
      ...
      Emit1 (74, LineCount);              --{MRC: this line is not in PC
                                          --version}
