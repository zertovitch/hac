...
package body HAC_Sys.Parser.Statements is
  ...
  is
    ...
    begin
      ...
      --  TBD: added a loop level with Id_label
    ...
    begin
      ...
      LC_Cond_Jump := CD.LC;
      Emit (CD, k_Jump_If_Zero_With_Pop);
      LOOP_Statement (k_Jump, LC_Cond_Eval, (label_Id, False));
    ...
    begin
      ...
      LOOP_Statement (For_END_Instruction (FOR_Begin_Instruction), CD.LC, (label_Id, True));
    ...
    begin
      ...
      case CD.Sy is
        ...
        when LOOP_Symbol =>
          LOOP_Statement (k_Jump, CD.LC, (CD.Id_Count, False));
          Check_ID_after_END_LOOP;
        when WHILE_Symbol =>
    ...
    if Statement_Begin_Symbol (CD.Sy) then
      case CD.Sy is
        ...
        when IF_Symbol =>
          IF_Statement;
        when LOOP_Symbol =>
          LOOP_Statement (k_Jump, CD.LC, (No_Id, False));
        when NULL_Symbol =>
